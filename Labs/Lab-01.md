...
1. In Document Intelligence Studio, scroll down to Custom Models and choose **Try it now**.
...
1. Navigate back to the Resource groups and select the resource group **document-intelligence -<inject key="Deployment ID" enableCopy="false"/>**.
